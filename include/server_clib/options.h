...
#define REQUIRED_ARGUMENT_SYMBOL '!'
#define OPTIONAL_ARGUMENT_SYMBOL ':'
...
typedef const char* (*options_get_option_details_ft)(const char short_opt);
...
typedef struct
{
    ...
    options_get_option_details_ft get_option_description;
    options_get_option_details_ft get_option_long_name;
} options_ctx_t;
